...
{    
    ...
    function Header()
    {
        ...
        $this->Cell(0,7,'DAFTAR ASSET NOTEBOOK '.$this->cin,0,0,'C');
        $this->Ln(14);
...
foreach($rows->result() as $data)
{
    ...
    $pdf->Cell(30,$height,$data->m_notebook_hostname,1,0,'C');
    $pdf->Cell(30,$height,$data->m_departemen_dept,1,0,'C');
    $pdf->Cell(30,$height,$data->m_notebook_user,1,0,'C');
    $pdf->Cell(30,$height,$data->m_notebook_masuk,1,0,'C');
    $pdf->Cell(30,$height,$data->m_notebook_keluar,1,0,'C');
    $pdf->Cell(40,$height,$data->m_notebook_keterangan,1,1,'C');
    
    $noUrut++;
}


$pdf->Output("Daftar Asset Notebook.pdf","I");
