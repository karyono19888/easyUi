        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="<?php echo base_url('Machmon/Heading/heading'); ?>">Home</a></li>
              <li class="breadcrumb-item active"><?php echo 'Heading '.$heading ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link">
                      LOT <span id="lot" class="float-right badge ">n/a</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4 text-center">
                    ...
                    <input type="text" id="voltage"  class="knob" data-max="400" data-angleArc="250" data-angleOffset="-125"
                      value="n/a" data-width="120" data-height="120" data-fgColor="#f56954">
                  </div>
                  <div class="col-md-4 text-center">
                    <div class="knob-label">Voltage (Std. 380~400 V)</div>
                    <input type="text" id="voltage2"  class="knob" data-max="400" data-angleArc="250" data-angleOffset="-125"
                      value="n/a" data-width="120" data-height="120" data-fgColor="#f56954">
                  </div>
                  <div class="col-md-4 text-center">
                    <div class="knob-label">Voltage (Std. 380~400 V)</div>
                    <input type="text" id="voltage3"  class="knob"  data-max="400" data-angleArc="250" data-angleOffset="-125"
                      value="n/a" data-width="120" data-height="120" data-fgColor="#f56954">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4 text-center">
                   ...
                   <div class="col-md-4 text-center">
                    <div class="knob-label">Cycle Time</div>
                    <input type="text" id="average"  class="knob" data-max="20" data-angleArc="250" data-angleOffset="-125"
                      value="n/a" data-width="120" data-height="120" data-fgColor="#f56954">
                  </div>
                   <div class="col-md-4 text-center">
                    <div class="knob-label">Qty/Minute</div>
                    <input type="text" id="qtyminute"  class="knob" data-max="100" data-angleArc="250" data-angleOffset="-125"
                      value="n/a" data-width="120" data-height="120" data-fgColor="#f56954">
                  </div>
                </div>
              </div>
...
/////////////////var
  ...
  var mc  = <?php echo $heading ?>;
  var ws;
  var wsUria = "ws://localhost:1880";   //change with your ip node red
  ...
  wsUri = wsUria+"/"+("hd"+mc,"ws/hd"+mc); //wsUri = wsUria+"/"+("hd2","ws/hd2"); wsUri = wsUria+"/"+("rl1","ws/rl1");
  function wsConnect() {
      ...
      ws.onmessage = function(msg) {
          ...
          document.getElementById('qtyminute').value = obj.qtyminute;
         // $("#pcsbox").trigger('change');
          ...
          document.getElementById('lot').innerHTML = obj.lot;
          document.getElementById('voltage').value = obj.voltage;
          document.getElementById('voltage2').value = obj.voltage;
          document.getElementById('voltage3').value = obj.voltage;
