        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="<?php echo base_url('Machmon/cutting/cutting'); ?>">Home</a></li>
              <li class="breadcrumb-item active"><?php echo 'cutting '.$cutting ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
/////////////////var
  ...
  wsUri = wsUria+"/"+("ct"+mc,"ws/ct"+mc); //wsUri = wsUria+"/"+("hd2","ws/hd2"); wsUri = wsUria+"/"+("rl1","ws/rl1");
  function wsConnect() {
