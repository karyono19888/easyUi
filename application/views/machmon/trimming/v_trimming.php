        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="<?php echo base_url('Machmon/trimming/trimming'); ?>">Home</a></li>
              <li class="breadcrumb-item active"><?php echo 'trimming '.$trimming ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
/////////////////var
  ...
  wsUri = wsUria+"/"+("tr"+mc,"ws/tr"+mc); //wsUri = wsUria+"/"+("hd2","ws/hd2"); wsUri = wsUria+"/"+("rl1","ws/rl1");
  function wsConnect() {
