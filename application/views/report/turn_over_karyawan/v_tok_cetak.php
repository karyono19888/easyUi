 ...
 foreach($detail->result() as $proses)
        {
            ...
            $pdf->Cell(20,$height,tgl($proses->t_tok_tgl),1,0,'C');
            $pdf->Cell(16,$height,$proses->t_tok_waktu_dari,1,0,'C');
            $pdf->Cell(16,$height,$proses->t_tok_waktu_sampai,1,0,'C');
            $pdf->Cell(20,$height,tgl($proses->t_tok_tgl2),1,0,'C');
            $pdf->Cell(16,$height,emptytime($proses->t_tok_waktu_dari2),1,0,'C');
            $pdf->Cell(16,$height,emptytime($proses->t_tok_waktu_sampai2),1,0,'C');
            ...
            $pdf->Cell(20,$height,tgl($proses->t_tok_aktual),1,1,'C');
