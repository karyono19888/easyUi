...
{    
    ...
    function Footer() {
       ...
       //$this->Cell(30,6,'28 September 2018',0,0,'L');
        ...
        $this->Cell(40,5,'DISETUJUI,',1,0,'C');
        $this->Cell(40,5,'DIBUAT,',1,0,'C');
        $this->Ln(5);
        ...
        $this->Ln(14);
        $this->Cell(115,5,'',0,0,'C');
        $this->Cell(20,5,'Mgr. HRD',1,0,'C');
        $this->Cell(20,5,'Mgr. Terkait',1,0,'C');
        $this->Cell(20,5,'Staff HRD',1,0,'C');
        $this->Cell(20,5,'SPV. Terkait',1,0,'C');
