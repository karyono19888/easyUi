...
<head>
    <meta charset="UTF-8">
    <title>Aplikasi HRIS SAGA</title>
    ...
    <script type="text/javascript" src="<?= base_url('assets/easyui/datagrid-export.js')?>"></script>
...
<body>
    ...
    <div class="easyui-layout" fit="true" style="width:700px;height:350px;">
        ...
        <div data-options="region:'south',split:false" style="height:100px;">
            <h1 align="center">Aplikasi Helpdesk IT. 1.0</h1>
    ...
    <script type="text/javascript">
        ...
        function startTime() {
            ...
            $('#clock').linkbutton({
                text: thisDay + ', ' + day + ' ' + months[month] + ' ' + year + ' - ' + curr_hour + ":" + curr_min + ":" + curr_sec
            });
        }
