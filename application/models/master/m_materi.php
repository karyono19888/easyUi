...
{    
    ...
    function index()
    {
        ...
        $offset = ($page-1)*$rows;      
        $sort   = isset($_POST['sort']) ? strval($_POST['sort']) : 'm_materi_no';
    ...
    function create($m_materi_nama){
        $query = $this->db->insert(self::$table,array(
            'm_materi_nama'            => $m_materi_nama
      ...
      function update($m_materi_no,$m_materi_nama)
    {
        $this->db->where('m_materi_no', $m_materi_no);
    ...
    function delete($m_materi_no)
    {
        $query = $this->db->delete(self::$table, array('m_materi_no' => $m_materi_no));
        if($query)
        {
            return json_encode(array('success'=>true));
        }
